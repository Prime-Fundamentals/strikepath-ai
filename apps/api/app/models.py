...
class Shot(Base):
    ...
    feet_depth_ft: Mapped[float] = mapped_column(Float, default=11.5)
...
class Recommendation(Base):
    ...
    feet_depth_delta_ft: Mapped[float] = mapped_column(Float, default=0)
    suggested_feet_depth_ft: Mapped[float] = mapped_column(Float, default=11.5)
    approach_title: Mapped[str] = mapped_column(String(180), default="Hold your approach depth")
    approach_explanation: Mapped[str] = mapped_column(Text, default="Keep the same starting depth and tempo.")
    suggested_speed_mph: Mapped[float | None] = mapped_column(Float, nullable=True)
    speed_title: Mapped[str] = mapped_column(String(180), default="Hold your speed")
    speed_explanation: Mapped[str] = mapped_column(Text, default="Repeat the same smooth tempo.")
    shot_plan_type: Mapped[str] = mapped_column(String(30), default="strike")
    leave_pins: Mapped[str | None] = mapped_column(String(80), nullable=True)
    suggested_feet_board: Mapped[float | None] = mapped_column(Float, nullable=True)
    suggested_laydown_board: Mapped[float | None] = mapped_column(Float, nullable=True)
    suggested_target_board: Mapped[float | None] = mapped_column(Float, nullable=True)
    suggested_breakpoint_board: Mapped[float | None] = mapped_column(Float, nullable=True)
    suggested_pocket_board: Mapped[float | None] = mapped_column(Float, nullable=True)
    recommended_ball_type: Mapped[str] = mapped_column(String(30), default="current")
